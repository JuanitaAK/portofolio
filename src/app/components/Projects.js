...
export default function Projects() {
    return (
        <section className="font-lato py-20 r">
            ...
            <div className="p-10 shadow-xl rounded-2xl my-5 mx-5">
                ...
                <ul className=" items-center grid gap-5 grid-cols-2 grid-rows-1">
                    <Image src={pico} className=" py-5 relative p-5" />
            ...
            <div className=" flex p-10 shadow-xl rounded-2xl my-5 mx-5">
                <ul className=" items-center grid gap-5 grid-cols-2 grid-rows-1">
                    <Image src={pico} className=" py-5 relative p-5" />
                    <div className="flex-col items-center p-3">
                        <p className="text-sm text-center pb-5 leading-6 text-gray-800">In a post-apocalyptic world, the player must escape from a mob of zombies. Programming in LUA language on the Pico-8 software. </p>
                        <a
                            className="text-center m-0 bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md mx-auto"
                            href="https://github.com/JuanitaAK/Pico-8--michonne-s-zombelad-">
                            Repository
                        </a>
                    </div>
